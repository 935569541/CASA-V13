...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the fixed three-seed V12 temporal-aware validation protocol."
    )
    parser.add_argument("--project", type=Path, default=Path(r"C:\casa"))
    parser.add_argument(
        "--data", type=Path,
        default=Path(r"C:\casa\data\processed\kuairand_50k_len500"),
    )
    parser.add_argument(
        "--teacher", type=Path,
    ...
    parser.add_argument(
        ...
        default=Path(r"C:\casa\runs\v12_validation_suite"),
    )
